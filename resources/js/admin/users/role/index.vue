<template>
    <div>
        ...
        <v-card>
            <v-card-title>
                Groups
                <router-link to="/Admin/users/role/add">
            ...
            >
                <template v-slot:item.action="{ item }">
                    <router-link :to="'/Admin/users/role/edit/'+item.id">
...
<script>
    export default {
        ...
        methods: {
            getroles() {
                this.axios.get('/users/role/index').then((res) => {
                    console.log(res);
            ...
            onDelete(id) {
                swal({
                    ...
                    dangerMode: true,
                        ...
                        if (willDelete) {
                            this.axios.post('/users/role/delete/' + id).then((res) => {
                                this.success = true;
